export const translations = {
  en: {
    hero: {
      ...
      subtitle: "Building and automating infrastructure for the modern web",
      description: "Passionate about cloud infrastructure, CI/CD pipelines, and creating scalable solutions. Specializing in Kubernetes, Docker, AWS, and automation tools.",
  ...
  fr: {
    hero: {
      ...
      subtitle: "Construction et automatisation d'infrastructure pour le web moderne",
      description: "Passionné par l'infrastructure cloud, les pipelines CI/CD et la création de solutions évolutives. Spécialisé dans Kubernetes, Docker, AWS et les outils d'automatisation.",
